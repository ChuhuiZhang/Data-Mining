...
infile = open("trainProdIntro_real.txt", "r")
# create 5 share of data (evenly distributed)
output1 = open("randomProdIntro_real_1.txt", "w")
output2 = open("randomProdIntro_real_2.txt", "w")
output3 = open("randomProdIntro_real_3.txt", "w")
output4 = open("randomProdIntro_real_4.txt", "w")
output5 = open("randomProdIntro_real_5.txt", "w")
...
output1 = open("randomProdIntro_real_1.txt", "r")
output2 = open("randomProdIntro_real_2.txt", "r")
output3 = open("randomProdIntro_real_3.txt", "r")
output4 = open("randomProdIntro_real_4.txt", "r")
output5 = open("randomProdIntro_real_5.txt", "r")
...
result_train = open("randomProdIntro_real_train.txt", "w")
