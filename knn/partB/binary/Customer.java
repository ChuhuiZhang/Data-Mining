...
public class Customer implements Comparable<Customer> {
	 ...
	 */
	private static double WEIGHT_SERVICE_TYPE = 2;
	private static double WEIGHT_CUSTOEMR = 0.01;
	private static double WEIGHT_MONTHLY_FEE = 1;
	private static double WEIGHT_BUDGET = 1;
	private static double WEIGHT_SIZE = 1;
	private static double WEIGHT_PROMOTION = 0.08;
	private static double WEIGHT_INTEREST_RATE = 1.5;
	private static double WEIGHT_PERIOD = 1;
	...
	public Customer(String inputRow) {
		...
		if (input.length == 9) {
			label = Integer.parseInt(input[8]);
		}
	}
